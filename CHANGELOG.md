...
### Bug Fixes:
- BatchEventProcessor will hang on poll after flushing with no event if no event count is greater than 3.
- EventDispatcher logs debug response and error responses from http post call.
