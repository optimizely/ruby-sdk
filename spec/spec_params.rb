...
module OptimizelySpec
  ...
  VALID_CONFIG_BODY_WITH_DIFF_ACCOUNT_ID = VALID_CONFIG_BODY.dup
  VALID_CONFIG_BODY_WITH_DIFF_ACCOUNT_ID['accountId'] = '12002'
  VALID_CONFIG_BODY_WITH_DIFF_ACCOUNT_ID['revision'] = '81'
  VALID_CONFIG_BODY_WITH_DIFF_ACCOUNT_ID_JSON = JSON.dump(VALID_CONFIG_BODY_WITH_DIFF_ACCOUNT_ID)
end
