...
describe Optimizely::HTTPProjectConfigManager do
  ...
  describe '.polling_interval' do
    ...
    it 'should log an error when polling_interval has invalid range' do
      ...
      expect(spy_logger).to have_received(:log).once.with(Logger::DEBUG, "Polling interval '999999999999999999' has invalid range. Defaulting to 300.")
    end
  end
  ...
  describe '.blocking_timeout' do
    ...
    it 'should log an error when blocking_timeout has invalid range' do
      ...
      expect(spy_logger).to have_received(:log).once.with(Logger::DEBUG, "Blocking timeout '999999999999999999' has invalid range. Defaulting to 15.")
    end
  end
end
