...
module Optimizely
  class OdpManager
    ...
    def initialize(disable:, segments_cache: nil, segment_manager: nil, event_manager: nil, fetch_segments_timeout: nil, odp_event_timeout: nil, odp_event_batch_size: nil, logger: nil)
      @enabled = !disable
